...
def show_page(current_lang, language_manager):
    ...
    st.markdown(
        f"""
        <style>
            /* ensure no stray gap above first block from Streamlit side */
            ...
            .hero-section {{
                ...
                text-align: center;
                color: white;
                transform: translateZ(0);          /* avoid hairline gaps on some GPUs */
            }}
            /* subtle fade at the very top so nav/buttons are readable on light photos */
            .hero-topfade {{
        ...
        <div class="hero-section">
            <div class="hero-topfade"></div>   <!-- makes nav/buttons readable on image -->
            <div class="hero-overlay"></div>
            <div class="hero-content">
                <h1>RestaurantLens</h1>
                <p>A restaurant reviews analyzer</p>
            </div>
        </div>
        """,
    ...
    # spacing after hero (keep small; adjust if you want it tighter)
